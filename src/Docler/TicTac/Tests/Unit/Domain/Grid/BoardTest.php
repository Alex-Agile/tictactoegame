...
namespace Docler\TicTac\Tests\Unit\Domain\Grid;

use Docler\TicTac\Domain\Grid\Board;
use Docler\TicTac\Domain\Grid\Cell;

/**
 * Class BoardTest
 *
 * Test suite for \Docler\TicTac\Domain\Grid\Board class
 *
 * @package Docler\TicTac\Tests\Unit\Domain\Grid
 */
class BoardTest extends \PHPUnit_Framework_TestCase
{
     ...
     *
     * @expectedException \Docler\TicTac\Exception\InvalidPositionException
     */
     ...
     *
     * @expectedException \Docler\TicTac\Exception\NotEmptyPositionException
     */
