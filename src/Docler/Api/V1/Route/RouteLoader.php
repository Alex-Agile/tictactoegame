...
namespace Docler\Api\V1\Route;

use Docler\Api\V1\Action\BotMoveAction;
use Docler\Api\V1\Action\MoveAction;
use Docler\App\Middleware\OauthMiddleware;
use Monolog\Logger;
 ...
 * Class RouteLoader
 *
 * Invokable Route loader object for Docler\Api\V1\Route package
 *
 * @package Docler\Api\V1\Route
 * @SWG\Info(
 *      title="Docler Tic Tac Toe Api V1", version="1.0",
 * )
 */
class RouteLoader
{
